...
async function startAuth({ state, nonce }) {
  ...
  // Google expects a single space-separated scope string
    url.searchParams.set(
      'scope',
      'openid email https://www.googleapis.com/auth/calendar.events https://www.googleapis.com/auth/calendar.readonly https://www.googleapis.com/auth/calendar.freebusy'
    );
